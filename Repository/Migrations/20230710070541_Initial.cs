        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketImage = table.Column<string>(nullable: true),
                    TicketPrice = table.Column<int>(nullable: false),
                    TicketRating = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketsInShoppingCarts", x => new { x.CartId, x.TicketId });
                    table.ForeignKey(
